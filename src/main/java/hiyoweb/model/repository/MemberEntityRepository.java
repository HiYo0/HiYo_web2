...
public interface MemberEntityRepository extends JpaRepository<MemberEntity,Integer> {
    ...
    Optional<BoardEntity> findByMemail(String memail);
    ...
    @Query(value = "select * from member m inner join" +
            " board b on m.mno = b.mno_fk where m.mno = :mno" , nativeQuery = true)
...
/*
    - 리포지토리 만드는 방법
    1. @Repository
    2. extends JpaRepository< 조작할엔티티 , PK필드의타입 >

    - 리포지토리 이용한 CRUD 메소드
    1. .save( 엔티티 )     : 해당 엔티티객체를 테이블에 삽입 IN
*/
